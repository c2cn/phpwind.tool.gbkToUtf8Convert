DROP TABLE IF EXISTS `pw9_acloud_apis`;
CREATE TABLE `pw9_acloud_apis` (
...
) ENGINE=MyISAM AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='aCloud预定义的系统接口列表';

DROP TABLE IF EXISTS `pw9_acloud_app_configs`;
CREATE TABLE `pw9_acloud_app_configs` (
...
DROP TABLE IF EXISTS `pw9_acloud_apps`;
CREATE TABLE `pw9_acloud_apps` (
  `app_id` char(22) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `pw9_acloud_extras`;
CREATE TABLE `pw9_acloud_extras` (
...
DROP TABLE IF EXISTS `pw9_acloud_keys`;
CREATE TABLE `pw9_acloud_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `modified_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='站点和云平台通信使用的密钥';

DROP TABLE IF EXISTS `pw9_acloud_sql_log`;
CREATE TABLE `pw9_acloud_sql_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `log` text,
  `created_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=176 DEFAULT CHARSET=utf8 COMMENT='aCloud执行SQL后记录的日志';

DROP TABLE IF EXISTS `pw9_acloud_table_settings`;
CREATE TABLE `pw9_acloud_table_settings` (
  `name` varchar(255) NOT NULL DEFAULT '',
  `status` tinyint(3) NOT NULL DEFAULT '0',
  `category` tinyint(3) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_admin_auth`;
CREATE TABLE `pw9_admin_auth` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='用户权限角色表';

DROP TABLE IF EXISTS `pw9_admin_config`;
CREATE TABLE `pw9_admin_config` (
...
DROP TABLE IF EXISTS `pw9_admin_custom`;
CREATE TABLE `pw9_admin_custom` (
  `username` varchar(15) NOT NULL,
  `custom` text COMMENT '常用菜单项',
  PRIMARY KEY (`username`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='后台常用菜单表';

DROP TABLE IF EXISTS `pw9_admin_role`;
CREATE TABLE `pw9_admin_role` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='后台用户角色表';

DROP TABLE IF EXISTS `pw9_advertisement`;
CREATE TABLE `pw9_advertisement` (
...
DROP TABLE IF EXISTS `pw9_announce`;
CREATE TABLE `pw9_announce` (
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='公告管理表';

DROP TABLE IF EXISTS `pw9_app_advert`;
CREATE TABLE `pw9_app_advert` (
...
DROP TABLE IF EXISTS `pw9_app_advert_seat`;
CREATE TABLE `pw9_app_advert_seat` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `identifier` varchar(50) NOT NULL DEFAULT '' COMMENT '广告位标示',
  `isopen` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否使用',
  `name` varchar(250) NOT NULL DEFAULT '' COMMENT '广告位名称',
  `desc` text NOT NULL COMMENT '广告位描述',
  `type_id` int(10) NOT NULL DEFAULT '1' COMMENT '类型',
  `width` varchar(10) NOT NULL DEFAULT '0' COMMENT '宽',
  `height` varchar(10) NOT NULL DEFAULT '0' COMMENT '高',
  `display` int(10) NOT NULL DEFAULT '0' COMMENT '显示方式',
  `issys` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否系统',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_bbsfenlei_type`;
CREATE TABLE `pw9_app_bbsfenlei_type` (
...
DROP TABLE IF EXISTS `pw9_app_bbsfenlei_typeoption`;
CREATE TABLE `pw9_app_bbsfenlei_typeoption` (
...
DROP TABLE IF EXISTS `pw9_app_bbsfenlei_typeoptionvar`;
CREATE TABLE `pw9_app_bbsfenlei_typeoptionvar` (
...
DROP TABLE IF EXISTS `pw9_app_bbsfenlei_typevar`;
CREATE TABLE `pw9_app_bbsfenlei_typevar` (
...
DROP TABLE IF EXISTS `pw9_app_majia`;
CREATE TABLE `pw9_app_majia` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '????ID????',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '?????󶨵??û?ID',
  `password` char(32) NOT NULL DEFAULT '' COMMENT '????????',
  PRIMARY KEY (`id`,`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_mark_record`;
CREATE TABLE `pw9_app_mark_record` (
...
DROP TABLE IF EXISTS `pw9_app_medz_vip20140529`;
CREATE TABLE `pw9_app_medz_vip20140529` (
  `uid` int(10) unsigned NOT NULL COMMENT '?û?id',
  `gid` int(10) unsigned NOT NULL COMMENT '?û???id',
  `oldgid` int(10) NOT NULL COMMENT '?û?????֮ǰ?û???id',
  `endtime` int(10) NOT NULL COMMENT '????ʱ??',
  PRIMARY KEY (`uid`),
  KEY `gid` (`gid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_mgoods_buy`;
CREATE TABLE `pw9_app_mgoods_buy` (
...
DROP TABLE IF EXISTS `pw9_app_mgoods_goods`;
CREATE TABLE `pw9_app_mgoods_goods` (
  `gid` int(10) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL,
  `tid` int(10) NOT NULL,
  `cover` varchar(100) NOT NULL,
  `count` int(5) NOT NULL DEFAULT '0',
  `show_only` tinyint(1) NOT NULL DEFAULT '0',
  `price` float NOT NULL,
  `buy` tinyint(10) NOT NULL,
  PRIMARY KEY (`gid`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_mgoods_price`;
CREATE TABLE `pw9_app_mgoods_price` (
...
DROP TABLE IF EXISTS `pw9_app_mgoods_way`;
CREATE TABLE `pw9_app_mgoods_way` (
  `wid` int(10) NOT NULL AUTO_INCREMENT,
  `gid` int(10) NOT NULL,
  `way` tinyint(1) NOT NULL,
  `link` varchar(300) NOT NULL,
  `credit` tinyint(5) NOT NULL,
  `rate` float NOT NULL,
  PRIMARY KEY (`wid`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_poll`;
CREATE TABLE `pw9_app_poll` (
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='投票基本信息表';

DROP TABLE IF EXISTS `pw9_app_poll_option`;
CREATE TABLE `pw9_app_poll_option` (
...
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='投票选项表';

DROP TABLE IF EXISTS `pw9_app_poll_thread`;
CREATE TABLE `pw9_app_poll_thread` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子ID',
  `poll_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '投票ID',
  `created_userid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '投票发起人',
  PRIMARY KEY (`tid`),
...
DROP TABLE IF EXISTS `pw9_app_poll_voter`;
CREATE TABLE `pw9_app_poll_voter` (
...
DROP TABLE IF EXISTS `pw9_app_pro_credit`;
CREATE TABLE `pw9_app_pro_credit` (
  `id` int(12) NOT NULL AUTO_INCREMENT,
  `uid` mediumint(8) NOT NULL,
  `username` varchar(20) NOT NULL,
  `type` varchar(20) NOT NULL,
  `logtype` tinyint(2) NOT NULL,
  `smoney` varchar(10) NOT NULL,
  `emoney` varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS `pw9_app_pro_user`;
CREATE TABLE `pw9_app_pro_user` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` mediumint(8) NOT NULL,
  `fuid1` mediumint(8) DEFAULT NULL,
  `fuid2` mediumint(8) DEFAULT NULL,
  `fuid3` mediumint(8) DEFAULT NULL,
  `fuid4` mediumint(8) DEFAULT NULL,
  `fuid5` mediumint(8) DEFAULT NULL,
  `fuid6` mediumint(8) DEFAULT NULL,
  `fuid7` mediumint(8) DEFAULT NULL,
  `fuid8` mediumint(8) DEFAULT NULL,
  `fuid9` mediumint(8) DEFAULT NULL,
  `fuid10` mediumint(8) DEFAULT NULL,
  `regdata` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_pro_users`;
CREATE TABLE `pw9_app_pro_users` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` mediumint(8) NOT NULL,
  `register` int(10) NOT NULL DEFAULT '0',
  `visit` int(10) NOT NULL DEFAULT '0',
  `visit_yx` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_pro_visit`;
CREATE TABLE `pw9_app_pro_visit` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uid` mediumint(8) NOT NULL,
...
DROP TABLE IF EXISTS `pw9_app_qqun`;
CREATE TABLE `pw9_app_qqun` (
  ...
  `times` int(10) NOT NULL DEFAULT '0' COMMENT 'ʱ??',
  `hits` int(10) NOT NULL DEFAULT '0' COMMENT '?Ķ?',
  `ip` varchar(25) NOT NULL DEFAULT '' COMMENT 'IP',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '?Ƿ?????',
  `title` varchar(150) NOT NULL DEFAULT '' COMMENT 'Ⱥ??',
  `content` text NOT NULL COMMENT '????',
  `type` int(10) NOT NULL DEFAULT '0' COMMENT '????',
  `qqun` varchar(20) NOT NULL DEFAULT '' COMMENT 'Ⱥ??',
  `qq` varchar(20) NOT NULL DEFAULT '' COMMENT 'Ⱥ????',
  `ctimes` varchar(20) NOT NULL DEFAULT '0' COMMENT '????ʱ??',
  `level` varchar(10) NOT NULL DEFAULT '0' COMMENT '?ȼ?',
  `url` varchar(180) NOT NULL DEFAULT '' COMMENT 'url',
  `kouhao` varchar(80) NOT NULL DEFAULT '' COMMENT '?ں?',
  PRIMARY KEY (`qid`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_qqun_type`;
CREATE TABLE `pw9_app_qqun_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `uid` int(10) NOT NULL DEFAULT '0' COMMENT '?û?ID',
...
DROP TABLE IF EXISTS `pw9_app_readprivilege`;
CREATE TABLE `pw9_app_readprivilege` (
  `tid` int(10) unsigned NOT NULL,
  `point` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Ȩ????ֵ',
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_replyreward`;
CREATE TABLE `pw9_app_replyreward` (
  `tid` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `pw9_app_replyreward_record`;
CREATE TABLE `pw9_app_replyreward_record` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `pw9_app_search_record`;
CREATE TABLE `pw9_app_search_record` (
...
DROP TABLE IF EXISTS `pw9_app_tags`;
CREATE TABLE `pw9_app_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `vieworder` int(10) NOT NULL DEFAULT '0' COMMENT '????',
  `tags` varchar(55) NOT NULL DEFAULT '' COMMENT '?ؼ???',
  `isopen` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '?Ƿ?ʹ??',
  `url` varchar(250) NOT NULL DEFAULT '' COMMENT 'url',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_verify`;
CREATE TABLE `pw9_app_verify` (
...
DROP TABLE IF EXISTS `pw9_app_verify_check`;
CREATE TABLE `pw9_app_verify_check` (
...
DROP TABLE IF EXISTS `pw9_app_withdraw`;
CREATE TABLE `pw9_app_withdraw` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `uid` int(10) DEFAULT NULL,
  `type` tinyint(1) NOT NULL,
  `account` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `paypass` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_withdraw_list`;
CREATE TABLE `pw9_app_withdraw_list` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  ...
  `payhao` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `times` (`times`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_yunlogin`;
CREATE TABLE `pw9_app_yunlogin` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `openid` varchar(255) DEFAULT NULL COMMENT 'APPid',
  `times` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '绑定时间',
  `lasttime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '最后登录时间',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '绑定用户',
  `nick` varchar(255) DEFAULT NULL COMMENT '平台用户名',
  `content` text NOT NULL COMMENT '平台信息',
  `type` varchar(10) NOT NULL DEFAULT 'qq' COMMENT '绑定类型',
  `hits` int(10) NOT NULL DEFAULT '0' COMMENT '绑定次数',
  `reg` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否绑定信息',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=841 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_yunqian`;
CREATE TABLE `pw9_app_yunqian` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '??̬ID',
  `uid` int(10) NOT NULL DEFAULT '0' COMMENT '?û?ID',
  `author` varchar(15) NOT NULL DEFAULT '' COMMENT '?û???',
  `times` int(10) NOT NULL DEFAULT '0' COMMENT 'ǩ??ʱ??',
  `qdxq` int(10) NOT NULL DEFAULT '0' COMMENT 'ǩ??????',
  `money` int(10) NOT NULL DEFAULT '0' COMMENT 'ǩ??????',
  `ip` varchar(100) NOT NULL DEFAULT '' COMMENT 'ǩ??ip',
  `content` text NOT NULL COMMENT 'ǩ??????',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2348 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_yunqian_count`;
CREATE TABLE `pw9_app_yunqian_count` (
  `id` smallint(3) unsigned NOT NULL AUTO_INCREMENT COMMENT '????ID',
  `newmember` varchar(15) NOT NULL DEFAULT '' COMMENT '???ջ?Ա',
  `total` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT 'ǩ??????',
  `higholnum` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '??ʷ????',
  `higholtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '??ʷ????ʱ??',
  `zqian` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '????ǩ??',
  `dqian` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '????ǩ??',
  `mqian` int(10) NOT NULL DEFAULT '0' COMMENT '??ͳ??',
  `dtime` int(10) NOT NULL DEFAULT '0' COMMENT '????ʱ??',
  `newuid` int(10) NOT NULL DEFAULT '0' COMMENT '????֮??UID',
  `mtime` int(10) NOT NULL DEFAULT '0' COMMENT '????ʱ??',
  `zmoney` int(10) NOT NULL DEFAULT '0' COMMENT '?ܽ???',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_yunqian_level`;
CREATE TABLE `pw9_app_yunqian_level` (
  `hits` int(10) NOT NULL COMMENT '??Ҫ????',
  `dj` int(10) NOT NULL COMMENT '?ȼ???',
  `title` varchar(100) NOT NULL COMMENT '?ȼ?????',
  PRIMARY KEY (`dj`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_app_yunqian_qduser`;
CREATE TABLE `pw9_app_yunqian_qduser` (
  `uid` int(10) NOT NULL COMMENT '?û?ID',
  `author` varchar(15) NOT NULL COMMENT '?û???',
  `times` int(10) NOT NULL COMMENT '????һ??ǩ??ʱ??',
  `money` int(10) NOT NULL COMMENT '?ܽ???',
  `day` int(10) NOT NULL COMMENT '??ǩ??????',
  `content` text NOT NULL COMMENT 'ǩ??????',
  `dj` int(10) NOT NULL DEFAULT '1' COMMENT 'ǩ???ȼ?',
  `dtop` int(10) NOT NULL DEFAULT '0' COMMENT '????????',
  `mday` int(10) NOT NULL DEFAULT '0' COMMENT '????ͳ??',
  `mtime` int(10) NOT NULL DEFAULT '0' COMMENT '????ʱ??',
  `qdxq` int(10) NOT NULL DEFAULT '1' COMMENT 'ǩ??????',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_application`;
CREATE TABLE `pw9_application` (
...
DROP TABLE IF EXISTS `pw9_application_log`;
CREATE TABLE `pw9_application_log` (
  `app_id` char(20) NOT NULL DEFAULT '' COMMENT '应用id',
...
DROP TABLE IF EXISTS `pw9_attachs`;
CREATE TABLE `pw9_attachs` (
...
) ENGINE=MyISAM AUTO_INCREMENT=1155 DEFAULT CHARSET=utf8 COMMENT='附件表';

DROP TABLE IF EXISTS `pw9_attachs_thread`;
CREATE TABLE `pw9_attachs_thread` (
...
DROP TABLE IF EXISTS `pw9_attachs_thread_buy`;
CREATE TABLE `pw9_attachs_thread_buy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_aid` (`aid`)
) ENGINE=MyISAM AUTO_INCREMENT=1866 DEFAULT CHARSET=utf8 COMMENT='帖子附件购买记录';

DROP TABLE IF EXISTS `pw9_attachs_thread_download`;
CREATE TABLE `pw9_attachs_thread_download` (
...
DROP TABLE IF EXISTS `pw9_attention`;
CREATE TABLE `pw9_attention` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_attention_fresh`;
CREATE TABLE `pw9_attention_fresh` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=1149 DEFAULT CHARSET=utf8 COMMENT='新鲜事主表';

DROP TABLE IF EXISTS `pw9_attention_fresh_index`;
CREATE TABLE `pw9_attention_fresh_index` (
...
DROP TABLE IF EXISTS `pw9_attention_fresh_relations`;
CREATE TABLE `pw9_attention_fresh_relations` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
  `fresh_id` int(10) unsigned NOT NULL DEFAULT '0',
  `type` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `created_userid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_attention_recommend_cron`;
CREATE TABLE `pw9_attention_recommend_cron` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户uid',
  `created_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='可能认识的人更新任务表';

DROP TABLE IF EXISTS `pw9_attention_recommend_friends`;
CREATE TABLE `pw9_attention_recommend_friends` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户uid',
...
DROP TABLE IF EXISTS `pw9_attention_recommend_record`;
CREATE TABLE `pw9_attention_recommend_record` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户uid',
...
DROP TABLE IF EXISTS `pw9_attention_type`;
CREATE TABLE `pw9_attention_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_attention_type_relations`;
CREATE TABLE `pw9_attention_type_relations` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
  `touid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_forum`;
CREATE TABLE `pw9_bbs_forum` (
...
) ENGINE=MyISAM AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='版块基本信息表';

DROP TABLE IF EXISTS `pw9_bbs_forum_extra`;
CREATE TABLE `pw9_bbs_forum_extra` (
...
DROP TABLE IF EXISTS `pw9_bbs_forum_statistics`;
CREATE TABLE `pw9_bbs_forum_statistics` (
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_forum_user`;
CREATE TABLE `pw9_bbs_forum_user` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_posts`;
CREATE TABLE `pw9_bbs_posts` (
  `pid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `app_mark` varchar(150) NOT NULL DEFAULT '',
  PRIMARY KEY (`pid`),
  KEY `idx_tid_disabled_createdtime` (`tid`,`disabled`,`created_time`),
  KEY `idx_disabled_createdtime` (`disabled`,`created_time`),
  KEY `idx_createduserid_createdtime` (`created_userid`,`created_time`)
) ENGINE=MyISAM AUTO_INCREMENT=8164 DEFAULT CHARSET=utf8 COMMENT='帖子回复表';

DROP TABLE IF EXISTS `pw9_bbs_posts_reply`;
CREATE TABLE `pw9_bbs_posts_reply` (
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  `rpid` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`pid`),
...
DROP TABLE IF EXISTS `pw9_bbs_posts_topped`;
CREATE TABLE `pw9_bbs_posts_topped` (
...
DROP TABLE IF EXISTS `pw9_bbs_specialsort`;
CREATE TABLE `pw9_bbs_specialsort` (
...
DROP TABLE IF EXISTS `pw9_bbs_threads`;
CREATE TABLE `pw9_bbs_threads` (
  ...
  KEY `idx_disabled_createdtime` (`disabled`,`created_time`),
  KEY `idx_createduserid_createdtime` (`created_userid`,`created_time`)
) ENGINE=MyISAM AUTO_INCREMENT=1100 DEFAULT CHARSET=utf8 COMMENT='帖子基本信息表';

DROP TABLE IF EXISTS `pw9_bbs_threads_buy`;
CREATE TABLE `pw9_bbs_threads_buy` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  `created_userid` int(10) unsigned NOT NULL DEFAULT '0',
  `created_time` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_threads_cate_index`;
CREATE TABLE `pw9_bbs_threads_cate_index` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_threads_content`;
CREATE TABLE `pw9_bbs_threads_content` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `useubb` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `usehtml` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `aids` smallint(5) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_threads_digest_index`;
CREATE TABLE `pw9_bbs_threads_digest_index` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `disabled` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `cid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_threads_hits`;
CREATE TABLE `pw9_bbs_threads_hits` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `hits` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_bbs_threads_index`;
CREATE TABLE `pw9_bbs_threads_index` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `disabled` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `created_time` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_threads_overtime`;
CREATE TABLE `pw9_bbs_threads_overtime` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbs_threads_sort`;
CREATE TABLE `pw9_bbs_threads_sort` (
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '版块ID',
  `tid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子ID',
...
DROP TABLE IF EXISTS `pw9_bbs_topic_type`;
CREATE TABLE `pw9_bbs_topic_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=77 DEFAULT CHARSET=utf8 COMMENT='主题分类表';

DROP TABLE IF EXISTS `pw9_bbs_topped`;
CREATE TABLE `pw9_bbs_topped` (
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  `created_time` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_bbsinfo`;
CREATE TABLE `pw9_bbsinfo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='论坛信息表';

DROP TABLE IF EXISTS `pw9_cache`;
CREATE TABLE `pw9_cache` (
...
DROP TABLE IF EXISTS `pw9_common_config`;
CREATE TABLE `pw9_common_config` (
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '配置名称',
  `namespace` varchar(15) NOT NULL DEFAULT 'global' COMMENT '配置命名空间',
  `value` text COMMENT '缓存值',
  `vtype` enum('string','array','object') NOT NULL DEFAULT 'string' COMMENT '配置值类型',
...
DROP TABLE IF EXISTS `pw9_common_cron`;
CREATE TABLE `pw9_common_cron` (
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='计划任务表';

DROP TABLE IF EXISTS `pw9_common_emotion`;
CREATE TABLE `pw9_common_emotion` (
...
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='表情数据表';

DROP TABLE IF EXISTS `pw9_common_emotion_category`;
CREATE TABLE `pw9_common_emotion_category` (
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='表情分类表';

DROP TABLE IF EXISTS `pw9_common_nav`;
CREATE TABLE `pw9_common_nav` (
...
) ENGINE=MyISAM AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='导航表';

DROP TABLE IF EXISTS `pw9_common_process`;
CREATE TABLE `pw9_common_process` (
...
DROP TABLE IF EXISTS `pw9_credit_log`;
CREATE TABLE `pw9_credit_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_createduserid_createdtime` (`created_userid`,`created_time`)
) ENGINE=MyISAM AUTO_INCREMENT=19759 DEFAULT CHARSET=utf8 COMMENT='积分日志表';

DROP TABLE IF EXISTS `pw9_credit_log_operate`;
CREATE TABLE `pw9_credit_log_operate` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_design_bak`;
CREATE TABLE `pw9_design_bak` (
...
DROP TABLE IF EXISTS `pw9_design_component`;
CREATE TABLE `pw9_design_component` (
...
) ENGINE=MyISAM AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='模版元件表';

DROP TABLE IF EXISTS `pw9_design_cron`;
CREATE TABLE `pw9_design_cron` (
...
DROP TABLE IF EXISTS `pw9_design_data`;
CREATE TABLE `pw9_design_data` (
  ...
  KEY `idx_vieworder` (`vieworder`)
) ENGINE=MyISAM AUTO_INCREMENT=1113844 DEFAULT CHARSET=utf8 COMMENT='数据缓存表';

DROP TABLE IF EXISTS `pw9_design_image`;
CREATE TABLE `pw9_design_image` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=156000 DEFAULT CHARSET=utf8 COMMENT='门户异步缩略图片表';

DROP TABLE IF EXISTS `pw9_design_module`;
CREATE TABLE `pw9_design_module` (
...
) ENGINE=MyISAM AUTO_INCREMENT=323 DEFAULT CHARSET=utf8 COMMENT='调用模块表';

DROP TABLE IF EXISTS `pw9_design_page`;
CREATE TABLE `pw9_design_page` (
...
) ENGINE=MyISAM AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='页面信息表';

DROP TABLE IF EXISTS `pw9_design_permissions`;
CREATE TABLE `pw9_design_permissions` (
...
DROP TABLE IF EXISTS `pw9_design_portal`;
CREATE TABLE `pw9_design_portal` (
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='自定义页面信息表';

DROP TABLE IF EXISTS `pw9_design_push`;
CREATE TABLE `pw9_design_push` (
...
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='信息推送表';

DROP TABLE IF EXISTS `pw9_design_script`;
CREATE TABLE `pw9_design_script` (
...
DROP TABLE IF EXISTS `pw9_design_segment`;
CREATE TABLE `pw9_design_segment` (
...
DROP TABLE IF EXISTS `pw9_design_shield`;
CREATE TABLE `pw9_design_shield` (
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='门户模块数据屏蔽表';

DROP TABLE IF EXISTS `pw9_design_structure`;
CREATE TABLE `pw9_design_structure` (
...
DROP TABLE IF EXISTS `pw9_domain`;
CREATE TABLE `pw9_domain` (
...
DROP TABLE IF EXISTS `pw9_draft`;
CREATE TABLE `pw9_draft` (
...
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='草稿箱';

DROP TABLE IF EXISTS `pw9_frag_template`;
CREATE TABLE `pw9_frag_template` (
...
DROP TABLE IF EXISTS `pw9_hook`;
CREATE TABLE `pw9_hook` (
...
DROP TABLE IF EXISTS `pw9_hook_inject`;
CREATE TABLE `pw9_hook_inject` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM AUTO_INCREMENT=1333 DEFAULT CHARSET=utf8 COMMENT='钩子挂载方法表';

DROP TABLE IF EXISTS `pw9_invite_code`;
CREATE TABLE `pw9_invite_code` (
...
DROP TABLE IF EXISTS `pw9_like_content`;
CREATE TABLE `pw9_like_content` (
...
) ENGINE=MyISAM AUTO_INCREMENT=375 DEFAULT CHARSET=utf8 COMMENT='喜欢内容表';

DROP TABLE IF EXISTS `pw9_like_log`;
CREATE TABLE `pw9_like_log` (
...
) ENGINE=MyISAM AUTO_INCREMENT=2387 DEFAULT CHARSET=utf8 COMMENT='喜欢记录表';

DROP TABLE IF EXISTS `pw9_like_source`;
CREATE TABLE `pw9_like_source` (
...
DROP TABLE IF EXISTS `pw9_like_statistics`;
CREATE TABLE `pw9_like_statistics` (
...
DROP TABLE IF EXISTS `pw9_like_tag`;
CREATE TABLE `pw9_like_tag` (
  ...
  PRIMARY KEY (`tagid`),
  KEY `idx_uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='喜欢分类表';

DROP TABLE IF EXISTS `pw9_like_tag_relations`;
CREATE TABLE `pw9_like_tag_relations` (
...
DROP TABLE IF EXISTS `pw9_link`;
CREATE TABLE `pw9_link` (
...
) ENGINE=MyISAM AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='友情链接表';

DROP TABLE IF EXISTS `pw9_link_relations`;
CREATE TABLE `pw9_link_relations` (
  `lid` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT '友情链接id',
  `typeid` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '分类id',
  PRIMARY KEY (`lid`,`typeid`)
) ENGINE=MyISAM AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COMMENT='友情链接分类关系表';

DROP TABLE IF EXISTS `pw9_link_type`;
CREATE TABLE `pw9_link_type` (
  ...
  PRIMARY KEY (`typeid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='友情链接分类表';

DROP TABLE IF EXISTS `pw9_log`;
CREATE TABLE `pw9_log` (
  ...
  KEY `idx_fid` (`fid`),
  KEY `idx_created_time` (`created_time`)
) ENGINE=MyISAM AUTO_INCREMENT=1224 DEFAULT CHARSET=utf8 COMMENT='前台管理日志表';

DROP TABLE IF EXISTS `pw9_log_login`;
CREATE TABLE `pw9_log_login` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  ...
  KEY `idx_ip` (`ip`),
  KEY `idx_created_time` (`created_time`)
) ENGINE=MyISAM AUTO_INCREMENT=1093 DEFAULT CHARSET=utf8 COMMENT='前台用户登录错误日志表';

DROP TABLE IF EXISTS `pw9_medal_info`;
CREATE TABLE `pw9_medal_info` (
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='勋章信息表';

DROP TABLE IF EXISTS `pw9_medal_log`;
CREATE TABLE `pw9_medal_log` (
...
) ENGINE=MyISAM AUTO_INCREMENT=2492 DEFAULT CHARSET=utf8 COMMENT='勋章记录表';

DROP TABLE IF EXISTS `pw9_medal_user`;
CREATE TABLE `pw9_medal_user` (
...
DROP TABLE IF EXISTS `pw9_medz_website_user`;
CREATE TABLE `pw9_medz_website_user` (
...
DROP TABLE IF EXISTS `pw9_message_config`;
CREATE TABLE `pw9_message_config` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户uid',
...
DROP TABLE IF EXISTS `pw9_message_notices`;
CREATE TABLE `pw9_message_notices` (
...
) ENGINE=MyISAM AUTO_INCREMENT=17560 DEFAULT CHARSET=utf8 COMMENT='通知表';

DROP TABLE IF EXISTS `pw9_online_guest`;
CREATE TABLE `pw9_online_guest` (
...
DROP TABLE IF EXISTS `pw9_online_statistics`;
CREATE TABLE `pw9_online_statistics` (
...
DROP TABLE IF EXISTS `pw9_online_user`;
CREATE TABLE `pw9_online_user` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_pay_order`;
CREATE TABLE `pw9_pay_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_createduserid` (`created_userid`)
) ENGINE=MyISAM AUTO_INCREMENT=286 DEFAULT CHARSET=utf8 COMMENT='支付订单表';

DROP TABLE IF EXISTS `pw9_recycle_reply`;
CREATE TABLE `pw9_recycle_reply` (
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `pw9_recycle_topic`;
CREATE TABLE `pw9_recycle_topic` (
  `tid` int(10) unsigned NOT NULL DEFAULT '0',
  `fid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `operate_time` int(10) unsigned NOT NULL DEFAULT '0',
  `operate_username` varchar(15) NOT NULL,
...
DROP TABLE IF EXISTS `pw9_remind`;
CREATE TABLE `pw9_remind` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户uid',
  `touid` varchar(255) NOT NULL DEFAULT '' COMMENT '最近提醒人',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='@最近提醒表';

DROP TABLE IF EXISTS `pw9_report`;
CREATE TABLE `pw9_report` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='举报表';

DROP TABLE IF EXISTS `pw9_seo`;
CREATE TABLE `pw9_seo` (
...
DROP TABLE IF EXISTS `pw9_space`;
CREATE TABLE `pw9_space` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_space_domain`;
CREATE TABLE `pw9_space_domain` (
  `domain` varchar(15) NOT NULL DEFAULT '' COMMENT '空间域名',
  `uid` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  PRIMARY KEY (`domain`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='空间域名表';

DROP TABLE IF EXISTS `pw9_style`;
CREATE TABLE `pw9_style` (
  `app_id` char(20) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `pw9_tag`;
CREATE TABLE `pw9_tag` (
...
) ENGINE=MyISAM AUTO_INCREMENT=127 DEFAULT CHARSET=utf8 COMMENT='话题表';

DROP TABLE IF EXISTS `pw9_tag_attention`;
CREATE TABLE `pw9_tag_attention` (
...
DROP TABLE IF EXISTS `pw9_tag_category`;
CREATE TABLE `pw9_tag_category` (
  ...
  `seo_keywords` varchar(255) NOT NULL DEFAULT '' COMMENT 'seo关键字',
  PRIMARY KEY (`category_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='话题分类表';

DROP TABLE IF EXISTS `pw9_tag_category_relation`;
CREATE TABLE `pw9_tag_category_relation` (
  `tag_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '话题id',
...
DROP TABLE IF EXISTS `pw9_tag_record`;
CREATE TABLE `pw9_tag_record` (
  `tag_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '话题id',
...
DROP TABLE IF EXISTS `pw9_tag_relation`;
CREATE TABLE `pw9_tag_relation` (
...
DROP TABLE IF EXISTS `pw9_task`;
CREATE TABLE `pw9_task` (
...
DROP TABLE IF EXISTS `pw9_task_cache`;
CREATE TABLE `pw9_task_cache` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `task_ids` varchar(200) NOT NULL DEFAULT '' COMMENT '该用户完成任务的最后ID记录及周期任务ID记录',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='任务缓存';

DROP TABLE IF EXISTS `pw9_task_group`;
CREATE TABLE `pw9_task_group` (
...
DROP TABLE IF EXISTS `pw9_task_user`;
CREATE TABLE `pw9_task_user` (
  `taskid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '任务ID',
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_upgrade_log`;
CREATE TABLE `pw9_upgrade_log` (
...
DROP TABLE IF EXISTS `pw9_user`;
CREATE TABLE `pw9_user` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `username` varchar(15) NOT NULL DEFAULT '' COMMENT '用户名字',
...
DROP TABLE IF EXISTS `pw9_user_active_code`;
CREATE TABLE `pw9_user_active_code` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_user_ban`;
CREATE TABLE `pw9_user_ban` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  ...
  KEY `idx_createdUid` (`created_userid`)
) ENGINE=MyISAM AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='用户禁止记录表';

DROP TABLE IF EXISTS `pw9_user_behavior`;
CREATE TABLE `pw9_user_behavior` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户UID',
...
DROP TABLE IF EXISTS `pw9_user_belong`;
CREATE TABLE `pw9_user_belong` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_user_data`;
CREATE TABLE `pw9_user_data` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  ...
  `app_signature_starttime` int(10) unsigned NOT NULL DEFAULT '0',
  `last_search_time` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户扩展数据表';

DROP TABLE IF EXISTS `pw9_user_education`;
CREATE TABLE `pw9_user_education` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='用户教育信息表';

DROP TABLE IF EXISTS `pw9_user_groups`;
CREATE TABLE `pw9_user_groups` (
  ...
  PRIMARY KEY (`gid`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='用户组表';

DROP TABLE IF EXISTS `pw9_user_info`;
CREATE TABLE `pw9_user_info` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_user_login_ip_recode`;
CREATE TABLE `pw9_user_login_ip_recode` (
...
DROP TABLE IF EXISTS `pw9_user_mobile`;
CREATE TABLE `pw9_user_mobile` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户uid',
...
DROP TABLE IF EXISTS `pw9_user_mobile_verify`;
CREATE TABLE `pw9_user_mobile_verify` (
  `mobile` bigint(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户手机号码',
...
DROP TABLE IF EXISTS `pw9_user_permission_groups`;
CREATE TABLE `pw9_user_permission_groups` (
...
DROP TABLE IF EXISTS `pw9_user_register_check`;
CREATE TABLE `pw9_user_register_check` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_user_register_ip`;
CREATE TABLE `pw9_user_register_ip` (
  `ip` varchar(20) NOT NULL DEFAULT '' COMMENT 'IP地址',
...
DROP TABLE IF EXISTS `pw9_user_tag`;
CREATE TABLE `pw9_user_tag` (
...
) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='用户个人标签基本信息表';

DROP TABLE IF EXISTS `pw9_user_tag_relation`;
CREATE TABLE `pw9_user_tag_relation` (
...
DROP TABLE IF EXISTS `pw9_user_work`;
CREATE TABLE `pw9_user_work` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
...
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='用户工作经历表';

DROP TABLE IF EXISTS `pw9_weibo`;
CREATE TABLE `pw9_weibo` (
...
) ENGINE=MyISAM AUTO_INCREMENT=390 DEFAULT CHARSET=utf8 COMMENT='微薄表';

DROP TABLE IF EXISTS `pw9_weibo_comment`;
CREATE TABLE `pw9_weibo_comment` (
...
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='微薄评论表';

DROP TABLE IF EXISTS `pw9_windid_admin_auth`;
CREATE TABLE `pw9_windid_admin_auth` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `uid` int(10) NOT NULL DEFAULT '0' COMMENT '用户ID',
  `username` varchar(15) NOT NULL DEFAULT '' COMMENT '用户名',
  `roles` varchar(255) NOT NULL DEFAULT '' COMMENT '角色',
...
DROP TABLE IF EXISTS `pw9_windid_admin_config`;
CREATE TABLE `pw9_windid_admin_config` (
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '配置名称',
  `namespace` varchar(15) NOT NULL DEFAULT 'global' COMMENT '配置命名空间',
  `value` text COMMENT '缓存值',
  `vtype` enum('string','array','object') NOT NULL DEFAULT 'string' COMMENT '配置值类型',
...
DROP TABLE IF EXISTS `pw9_windid_admin_custom`;
CREATE TABLE `pw9_windid_admin_custom` (
  `username` varchar(15) NOT NULL,
  `custom` text COMMENT '常用菜单项',
  PRIMARY KEY (`username`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `pw9_windid_admin_role`;
CREATE TABLE `pw9_windid_admin_role` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `name` varchar(15) NOT NULL DEFAULT '' COMMENT '角色名',
  `auths` text COMMENT '权限点',
  `created_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
...
DROP TABLE IF EXISTS `pw9_windid_app`;
CREATE TABLE `pw9_windid_app` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='应用数据表';

DROP TABLE IF EXISTS `pw9_windid_application`;
CREATE TABLE `pw9_windid_application` (
  `app_id` char(20) NOT NULL DEFAULT '' COMMENT '应用id',
  `name` varchar(100) NOT NULL DEFAULT '' COMMENT '名称',
  `alias` varchar(100) NOT NULL DEFAULT '' COMMENT '别名',
  `logo` varchar(100) NOT NULL DEFAULT '' COMMENT '应用logo',
...
DROP TABLE IF EXISTS `pw9_windid_application_log`;
CREATE TABLE `pw9_windid_application_log` (
  `app_id` char(20) NOT NULL DEFAULT '' COMMENT '应用id',
  `log_type` char(10) NOT NULL DEFAULT '' COMMENT '日志类型',
  `data` text COMMENT '日志内容',
  `created_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
...
DROP TABLE IF EXISTS `pw9_windid_area`;
CREATE TABLE `pw9_windid_area` (
...
DROP TABLE IF EXISTS `pw9_windid_config`;
CREATE TABLE `pw9_windid_config` (
...
DROP TABLE IF EXISTS `pw9_windid_hook`;
CREATE TABLE `pw9_windid_hook` (
  `name` varchar(50) NOT NULL DEFAULT '',
  `app_id` char(20) NOT NULL DEFAULT '' COMMENT '应用id',
  `app_name` varchar(100) NOT NULL DEFAULT '' COMMENT '应用名称',
  `created_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
...
DROP TABLE IF EXISTS `pw9_windid_hook_inject`;
CREATE TABLE `pw9_windid_hook_inject` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `app_id` char(20) NOT NULL DEFAULT '',
  `app_name` varchar(100) NOT NULL DEFAULT '',
  `hook_name` varchar(100) NOT NULL DEFAULT '' COMMENT '钩子名',
...
DROP TABLE IF EXISTS `pw9_windid_message`;
CREATE TABLE `pw9_windid_message` (
...
) ENGINE=MyISAM AUTO_INCREMENT=264 DEFAULT CHARSET=utf8 COMMENT='消息内容表';

DROP TABLE IF EXISTS `pw9_windid_message_dialog`;
CREATE TABLE `pw9_windid_message_dialog` (
...
) ENGINE=MyISAM AUTO_INCREMENT=249 DEFAULT CHARSET=utf8 COMMENT='消息对话表';

DROP TABLE IF EXISTS `pw9_windid_message_relation`;
CREATE TABLE `pw9_windid_message_relation` (
...
) ENGINE=MyISAM AUTO_INCREMENT=527 DEFAULT CHARSET=utf8 COMMENT='消息关系表';

DROP TABLE IF EXISTS `pw9_windid_notify`;
CREATE TABLE `pw9_windid_notify` (
  ...
  PRIMARY KEY (`nid`)
) ENGINE=MyISAM AUTO_INCREMENT=27534 DEFAULT CHARSET=utf8 COMMENT='通知队列表';

DROP TABLE IF EXISTS `pw9_windid_notify_log`;
CREATE TABLE `pw9_windid_notify_log` (
...
DROP TABLE IF EXISTS `pw9_windid_school`;
CREATE TABLE `pw9_windid_school` (
...
) ENGINE=MyISAM AUTO_INCREMENT=1001292 DEFAULT CHARSET=utf8 COMMENT='统一的windid学校库';

DROP TABLE IF EXISTS `pw9_windid_user`;
CREATE TABLE `pw9_windid_user` (
  ...
  UNIQUE KEY `idx_username` (`username`),
  KEY `idx_email` (`email`)
) ENGINE=MyISAM AUTO_INCREMENT=3394 DEFAULT CHARSET=utf8 COMMENT='windid用户基本信息表';

DROP TABLE IF EXISTS `pw9_windid_user_black`;
CREATE TABLE `pw9_windid_user_black` (
  `uid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户uid',
  `blacklist` text COMMENT '黑名单',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户黑名单';

DROP TABLE IF EXISTS `pw9_windid_user_data`;
CREATE TABLE `pw9_windid_user_data` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_windid_user_info`;
CREATE TABLE `pw9_windid_user_info` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户ID',
...
DROP TABLE IF EXISTS `pw9_word`;
CREATE TABLE `pw9_word` (
